      ...
      <div className="review">
        ...
        <aside className="review__aside">
          <div className="card review__summary">
            ...
            {/*
              What's being bought, from both routes at once: items swapped for
              a specific replacement, and a basket paid for with what's left
              pooled. Keying this off the per-line decisions alone left the
              basket invisible for the whole of shop now; showing only the
              basket, once the two could be mixed, hid a swap the shopper is
              being charged for on the very next line.
            */}
            {(shopping || exchanges.length > 0) && (
              <div className="summary__section">
                <div className="summary__heading">
            ...
            */}
            ...
            {/*
              ...
              Either way it needs money to be going back. A return whose
              credit is entirely consumed by an upgrade pays out nothing, and
              asking how someone would like to receive nothing — directly
              above a total telling them they owe 54,838 — is a question with
              no answer.
            */}
            {(choosingForSurplus ||
              (!shopping && returning.length > 0 && net > 0.005)) && (
              <div className="summary__section">
