...
export const en = {
  ...
  "orders.placed": "Placed on {date}",
  "orders.create": "Create return",
  "orders.view": "View return",
  "orders.notReturnable": "Not returnable",
  "orders.empty": "You have no orders to return yet.",
  "orders.other": "Return a different order",
  "orders.heading": "Returns Center",
  "orders.policyTitle": "Return policy",
  "orders.policy.DELIVERY": "We accept returns within {days} days of delivery.",
  "orders.policy.FULFILLMENT": "We accept returns within {days} days of shipment.",
