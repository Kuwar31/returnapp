...
export const en = {
  ...
  "drawer.exchangeNote": "Anything we should know about this exchange?",
  "drawer.exchangeNotePlaceholder": "Optional",
  // --- AI exchange: the recommendation before the ordinary choice ---------
  "ai.title": "A better match for you",
  "ai.intro": "Based on your return, we found an exchange option you may prefer.",
  "ai.switch": "Show another option",
  "ai.details": "Product details",
  "ai.similar": "Similar choices",
  "ai.priceCaption": "your price",
  "ai.primary": "Get it now",
  "ai.secondary": "No, thanks",
  "ai.free": "Free exchange",
  "ai.bestMatch": "Best match",
  "ai.refund": "You'll get {amount} back",
  "ai.pay": "You'll pay {amount} more",
  "ai.even": "Nothing more to pay",
  // Why the recommended option — the reason, answered.
  "ai.why.sizeUp": "One size up from {from}",
  "ai.why.sizeDown": "One size down from {from}",
  "ai.why.shorter": "The same size, shorter",
  "ai.why.longer": "The same size, longer",
  "ai.why.colour": "The same size in another colour",
  "ai.why.replacement": "A straight replacement of what you ordered",
  "ai.why.history": "What other shoppers chose for the same reason",
